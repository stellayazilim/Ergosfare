...
public sealed class FinishPostInterceptorInvocationEvent: PipelineEventBase
{
    
    public required Type InterceptorType { get; init; }

    public static FinishPostInterceptorInvocationEvent Create(Type mediatorInstance, Type messageType, Type interceptorType, Type? resultType) => new()
    {
