...
using Contexts_ExecutionContext = Ergosfare.Core.Internal.Contexts.ExecutionContext;
    ...
    : IMessageMediator
{
    ...
    public TResult Mediate<TMessage, TResult>(TMessage message, MediateOptions<TMessage, TResult> options) where TMessage : IMessage
    {
        ...
        var executionContext = new Contexts_ExecutionContext(options.CancellationToken,  options.Items);
