...
internal sealed partial class PlanBuilder
{
    ...
    /// </para>
    /// </remarks>
    private static List<PipelineDescriptorModel> ComputePipelineDescriptors(
        List<RegistrableTypeModel> types, List<RegistrableTypeModel> excludedShadows)
    {
        var compositions = new List<PipelineDescriptorModel>();
        ...
        foreach (var message in Enumerate(types, excludedShadows))
        {
            ...
            compositions.Add(new PipelineDescriptorModel(
