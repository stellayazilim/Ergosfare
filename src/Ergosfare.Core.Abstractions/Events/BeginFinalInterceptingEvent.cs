...
/// </summary>
public sealed class BeginFinalInterceptingEvent: PipelineEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new instance of <see cref="BeginFinalInterceptingEvent"/>.
    /// </summary>
    ...
    /// <returns>A new <see cref="BeginFinalInterceptingEvent"/> instance.</returns>
    public static BeginFinalInterceptingEvent Create(object message, object? result, Exception? exception, ushort interceptorCount = 0) => 
        new()
        {
