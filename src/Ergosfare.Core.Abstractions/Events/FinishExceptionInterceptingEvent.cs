...
public sealed class FinishExceptionInterceptingEvent: PipelineEvent
{
    public required Exception Exception { get; init; }
    
    public static FinishExceptionInterceptingEvent Create(object message, object? result, Exception exception) => new()
    {
