...
// (ITestOutputHelper  testOutputHelper): IClassFixture<SignalHubFixture>
// {
//     
//     [Fact]
...
//
//         
//         PipelineSignal.Subscribe<BeginPostInterceptingEvent>(@event =>
//         {   
...
//         });
//         
//         PipelineSignal.Subscribe<FinishPostInterceptorInvocationSignal>(@event =>
//         {   
//             Assert.NotNull( @event.Message);
//         });
//         PipelineSignal.Subscribe<FinishPostInterceptingWithExceptionSignal>(@event =>
//         {   
