...
/// <c>AddPipelineDescriptor</c> table entry carrying all six stages as pre-sorted
...
/// </summary>
public class PipelineDescriptorEmissionTests
{
    [Fact]
    public void InterceptedCommand_BakesEverySegmentInRuntimeOrder()
    {
        ...
        Assert.Contains("AddPipelineDescriptor(new global::Stella.Ergosfare.Core.Abstractions.Planning.PipelineDescriptor(", source);
        ...
        var heavy = source.IndexOf("new global::Stella.Ergosfare.Core.Abstractions.Planning.FrozenParticipant(typeof(global::TestApp.HeavyPre))", StringComparison.Ordinal);
        var alpha = source.IndexOf("new global::Stella.Ergosfare.Core.Abstractions.Planning.FrozenParticipant(typeof(global::TestApp.AlphaPre))", StringComparison.Ordinal);
        var zeta = source.IndexOf("new global::Stella.Ergosfare.Core.Abstractions.Planning.FrozenParticipant(typeof(global::TestApp.ZetaPre))", StringComparison.Ordinal);
    ...
    private static List<string> CompositionBlocks(string source)
    {
        ...
        while ((position = source.IndexOf("AddPipelineDescriptor(", position, StringComparison.Ordinal)) >= 0)
        {
