...
namespace Stella.Ergosfare.Core.Test.SignalHub;
...
public class ProxySignalTests
{
    ...
    {
        // Arrange
        var hub = new Stella.Ergosfare.Core.Abstractions.SignalHub.SignalHub();
        var properties = typeof(Stella.Ergosfare.Core.Abstractions.SignalHub.SignalHub).GetProperties(BindingFlags.Public | BindingFlags.Instance);
    ...
    {
        // Arrange
        var property = typeof(Stella.Ergosfare.Core.Abstractions.SignalHub.SignalHub).GetProperty(propertyName)!;
        // Assert
