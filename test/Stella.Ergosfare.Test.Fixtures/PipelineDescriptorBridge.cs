...
/// <summary>
/// Builds the <see cref="PipelineDescriptor"/> the dispatch path reads out of a message
...
/// </remarks>
public static class PipelineDescriptorBridge
{
    /// <summary>
    ...
    /// </summary>
    public static PipelineDescriptor FromTypes(Type messageType, IEnumerable<Type> participantTypes)
    {
